...
{
    public partial class TableA5 : Form
    {
        public string filename { get; set; }
        public TableA5(string Table)
        {
            InitializeComponent();
            filename = Table;
        ...
        private TableA5ChefView TableA5ChefView = new TableA5ChefView("Table A5");
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e) // Served button 2
        {
            ...
            Chef_s_View.UpdateLabelA5("A5!");
            Chef_s_View.Show();
            TableA5ChefView.UpdateTextbox2("Served");
            TableA5ChefView.Show();
        }
        ...
        private void guna2CircleButton1_Click(object sender, EventArgs e) // Served button 1
        {
            ...
            TableA5ChefView.UpdateTextbox("Served");
            TableA5ChefView.Show();
        }
        ...
        private void guna2CircleButton3_Click(object sender, EventArgs e) // Served button 3
        {
            ...
            TableA5ChefView.UpdateTextbox3("Served");
            TableA5ChefView.Show();
        }
    }
}
