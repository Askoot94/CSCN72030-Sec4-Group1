...
{
    public partial class TableA6 : Form
    {
        public string filename { get; set; }
        public TableA6(string Table)
        {
            InitializeComponent();
            filename = Table;
        ...
        private void TableA6_Load(object sender, EventArgs e)
        {
        ...
        private TableA6ChefView TableA6ChefView = new TableA6ChefView("Table A6");
        ...
        private void guna2CircleButton1_Click(object sender, EventArgs e) // Served button 1
        {
            ...
            Chef_s_View.UpdateLabelA6("A6!");
            Chef_s_View.Show();
            TableA6ChefView.UpdateTextbox("Served");
            TableA6ChefView.Show();
        }
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e) // Served button 2
        {
            ...
            TableA6ChefView.UpdateTextbox2("Served");
            TableA6ChefView.Show();
        }
        ...
        private void guna2CircleButton3_Click(object sender, EventArgs e) // Served button 3
        {
            ...
            TableA6ChefView.UpdateTextbox3("Served");
            TableA6ChefView.Show();
        }
    }
}
