...
{
    public partial class MainMenuB1 : Form
    {
        public string tableOrder;

        public MainMenuB1(string table)
        {
            InitializeComponent();
        ...
        private void MainMenuB1_Load(object sender, EventArgs e)
        {
        ...
        private void guna2Button19_Click(object sender, EventArgs e) // Order Status
        {
            ...
            if (iOpen == DialogResult.OK)
            {
                ...
                Waiter_s_view.UpdateLabelB1("B1 !");
                Waiter_s_view.Show();
            }
        }
        ...
        private void MainMenuB1_Load_1(object sender, EventArgs e)
        {
        }
