...
{
    public partial class TableC1 : Form
    {
        public string filename { get; set; }
        public TableC1(string Table)
        {
            InitializeComponent();
            filename = Table;
        ...
        private void TableC1_Load(object sender, EventArgs e)
        {
        ...
        private TableC1ChefView TableC1ChefView = new TableC1ChefView("Table C1");
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e) // Served button 2
        {
            ...
            Chef_s_View.UpdateLabelC1("C1 !");
            Chef_s_View.Show();

            TableC1ChefView.UpdateTextbox2("Served");
            TableC1ChefView.Show();

        }

        private void guna2CircleButton1_Click(object sender, EventArgs e) // Served button 1
        {
            textBox17.Text = ("Served");
            Chef_s_View.UpdateLabelC1("C1 !");
            Chef_s_View.Show();

            TableC1ChefView.UpdateTextbox("Served");
            TableC1ChefView.Show();
        }
        ...
        private void guna2CircleButton3_Click(object sender, EventArgs e) // Served button 3
        {
            ...
            TableC1ChefView.UpdateTextbox3("Served");
            TableC1ChefView.Show();
        }
    }
}
