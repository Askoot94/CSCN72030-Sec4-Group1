...
namespace _Project_III_GUI
{
    public partial class MainMenuA3 : Form
    {
        ...
        private void ButtonPlus1_Click_1(object sender, EventArgs e) // Increase 1 
        {
        ...
        private void ButtonPlus3_Click_1(object sender, EventArgs e) // Increase 3
        {
        ...
        private void ButtonPlus5_Click_1(object sender, EventArgs e) // Increase 5
        {
            IncrementQuantity(TxtBox5);

        }
        private void ButtonPlus6_Click_1(object sender, EventArgs e) // Increase 6
        {
            IncrementQuantity(TxtBox6);

        }

        private void ButtonPlus7_Click_1(object sender, EventArgs e) // Increase 7
        {
        ...
        private void ButtonMinus1_Click_1(object sender, EventArgs e) // Decrease 1
        {
        ...
        private void ButtonMinus5_Click_1(object sender, EventArgs e)
        {
            DecrementQuantity(TxtBox5);

        }

        private void ButtonMinus6_Click_1(object sender, EventArgs e)
        {
        ...
        private void ButtonMinus7_Click_1(object sender, EventArgs e)
        {
            DecrementQuantity(TxtBox7);

        }

        private void ButtonMinus8_Click_1(object sender, EventArgs e)
        {
        ...
        private void guna2Button18_Click_1(object sender, EventArgs e) // send button
        {
