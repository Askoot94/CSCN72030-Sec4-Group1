...
{
    public partial class TableB3 : Form
    {
        public string filename { get; set; }
        public TableB3(string Table)
        {
            InitializeComponent();
            filename = Table;
        ...
        private void TableB3_Load(object sender, EventArgs e)
        {
        ...
        private TableB3ChefView TableB3ChefView = new TableB3ChefView("Table B3");
        ...
        private void guna2CircleButton1_Click(object sender, EventArgs e) // Served button 1
        {
            ...
            Chef_s_View.UpdateLabelB3("B3 !");
            Chef_s_View.Show();
            TableB3ChefView.UpdateTextbox("Served");
            TableB3ChefView.Show();
        }
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e) // Served button 2
        {
            ...
            Chef_s_View.UpdateLabelB3("B3 !");
            Chef_s_View.Show();
            TableB3ChefView.UpdateTextbox2("Served");
            TableB3ChefView.Show();
        }
        ...
        private void guna2CircleButton3_Click(object sender, EventArgs e) // Served button 3
        {
            ...
            Chef_s_View.UpdateLabelB3("B3 !");
            Chef_s_View.Show();
            TableB3ChefView.UpdateTextbox3("Served");
            TableB3ChefView.Show();
        }
