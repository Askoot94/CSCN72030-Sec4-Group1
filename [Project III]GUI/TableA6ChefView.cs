...
{
    public partial class TableA6ChefView : Form
    {
        public string Table { get; set; }
        public TableA6ChefView(string filename)
        {
            InitializeComponent();
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e)
        {
            ...
            Waiter_s_View.UpdateLabelA6("A6!");
            Waiter_s_View.Show();
        }
        ...
        private void TableA6ChefView_Load(object sender, EventArgs e)
        {
