...
namespace _Project_III_GUI
{
    public partial class TableC2 : Form
    {
        ...
        private void TableC2_Load(object sender, EventArgs e)
        {
        ...
        private TableC2ChefView TableC2ChefView = new TableC2ChefView("Table C2");
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e) // Served button 2
        {
            ...
            Chef_s_View.UpdateLabelC2("C2 !");
            Chef_s_View.Show();

            TableC2ChefView.UpdateTextbox2("Served");
            TableC2ChefView.Show();
        }
        ...
        private void guna2CircleButton1_Click(object sender, EventArgs e) // Served button 1
        {
            ...
            Chef_s_View.UpdateLabelC2("C2 !");
            Chef_s_View.Show();
            TableC2ChefView.UpdateTextbox("Served");
            TableC2ChefView.Show();
        }
        ...
        private void guna2CircleButton3_Click(object sender, EventArgs e) // Served button 3
        {
            ...
            Chef_s_View.UpdateLabelC2("C2 !");
            Chef_s_View.Show();
            TableC2ChefView.UpdateTextbox3("Served");
            TableC2ChefView.Show();
        }
    }
}
