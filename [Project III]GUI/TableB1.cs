...
{
    public partial class TableB1 : Form
    {
        public string filename { get; set; }
        public TableB1(string Table)
        {
            InitializeComponent();
            filename = Table;
        ...
        private void TableB1_Load(object sender, EventArgs e)
        {
        ...
        private TableB1ChefView TableB1ChefView = new TableB1ChefView("Table B1");
        ...
        private void guna2CircleButton1_Click(object sender, EventArgs e) // Served button 1
        {
            ...
            Chef_s_View.UpdateLabelB1("B1 !");
            Chef_s_View.Show();
            TableB1ChefView.UpdateTextbox("Served");
            TableB1ChefView.Show();
        ...
        private void guna2CircleButton2_Click(object sender, EventArgs e) // Served button 2
        {
            ...
            Chef_s_View.UpdateLabelB1("B1 !");
            Chef_s_View.Show();
            TableB1ChefView.UpdateTextbox2("Served");
            TableB1ChefView.Show();
        }
        ...
        private void guna2CircleButton3_Click(object sender, EventArgs e) // Served button 3
        {
            ...
            Chef_s_View.UpdateLabelB1("B1 !");
            Chef_s_View.Show();
            TableB1ChefView.UpdateTextbox3("Served");
            TableB1ChefView.Show();
        }
